...
student::~student()
{
	cout<<" Hey, this is destructor ! Im going to write to primary index "<<endl;
	ofstream fout;
	fout.open("pri_index.txt",ios::app);
	if(num_keys==0)
	{
